...
namespace com.appscode.voyager.Models
{
    ...
    public partial class V1beta1IngressRule
    {
        ...
        public V1beta1IngressRule(string host = default(string), V1beta1HTTPIngressRuleValue http = default(V1beta1HTTPIngressRuleValue), V1beta1TCPIngressRuleValue tcp = default(V1beta1TCPIngressRuleValue))
        {
            Host = host;
            Http = http;
            Tcp = tcp;
        ...
        public V1beta1TCPIngressRuleValue Tcp { get; set; }
