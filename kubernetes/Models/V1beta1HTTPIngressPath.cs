...
namespace com.appscode.voyager.Models
{
    ...
    public partial class V1beta1HTTPIngressPath
    {
        ...
        /// <param name="path">Path is a extended POSIX regex as defined by
        ...
        public V1beta1HTTPIngressPath(V1beta1HTTPIngressBackend backend = default(V1beta1HTTPIngressBackend), string path = default(string))
        {
            Backend = backend;
            Path = path;
            CustomInit();
        ...
        /// <summary>
        /// Gets or sets path is a extended POSIX regex as defined by IEEE Std
