...
namespace com.appscode.voyager.Models
{
    ...
    public partial class V1beta1IngressStatus
    {
        ...
        public V1beta1IngressStatus(k8s.Models.V1LoadBalancerStatus loadBalancer = default(k8s.Models.V1LoadBalancerStatus))
        {
        ...
        public k8s.Models.V1LoadBalancerStatus LoadBalancer { get; set; }
