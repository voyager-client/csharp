...
namespace com.appscode.voyager.Models
{
    ...
    public partial class V1beta1CertificateCondition
    {
        /// <summary>
        /// Initializes a new instance of the V1beta1CertificateCondition
        /// class.
        /// </summary>
        public V1beta1CertificateCondition()
        {
            CustomInit();
        }
        ...
        public V1beta1CertificateCondition(string type, System.DateTime? lastUpdateTime = default(System.DateTime?), string message = default(string), string reason = default(string))
        {
